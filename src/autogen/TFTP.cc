// Begin of TFTP (from "/Users/bbannier/src/spicy-tftp/src/tftp.spicy")
...
auto __hlt::TFTP::Acknowledgement::__parse_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    try {
        hilti::rt::debug::indent(std::string("spicy"));
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:77:24-79:2");
        (*__self).__on_0x25_init();

        // Begin parsing production: Variable: num_4 -> uint<16>;
        spicy::rt::detail::waitForInput(__data, __cur, hilti::rt::integer::safe<std::uint64_t>{2u}, std::string("expecting 2 bytes for unpacking value"), std::string("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:78:10"), hilti::rt::StrongReference<spicy::rt::filter::detail::Filters>());
        ...
        // End parsing production: Variable: num_4 -> uint<16>;

          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:78:5");
        (*__self).__on_num(hilti::rt::optional::value((*__self).num, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:78:5"));
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:77:24-79:2");
...
extern auto __hlt::TFTP::Acknowledgement::parse1(hilti::rt::ValueReference<hilti::rt::Stream>& data, const std::optional<hilti::rt::stream::View>& cur) -> hilti::rt::stream::View {
    ...
    // Begin parsing production: Unit: TFTP_Acknowledgement_2 -> num_4;
    std::tie(ncur, lahead, lahead_end) = (*unit).__parse_stage1(data, ncur, hilti::rt::Bool(true), lahead, lahead_end);
    // End parsing production: Unit: TFTP_Acknowledgement_2 -> num_4;
...
auto __hlt::TFTP::Data::__parse_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    try {
        ...
        hilti::rt::debug::indent(std::string("spicy"));
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:64:13-67:2");
        (*__self).__on_0x25_init();

        // Begin parsing production: Variable: num_3 -> uint<16>;
        spicy::rt::detail::waitForInput(__data, __cur, hilti::rt::integer::safe<std::uint64_t>{2u}, std::string("expecting 2 bytes for unpacking value"), std::string("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:65:11"), hilti::rt::StrongReference<spicy::rt::filter::detail::Filters>());
        std::tie(hilti::rt::optional::valueOrInit((*__self).num), __cur) = hilti::rt::integer::unpack<uint16_t>(__cur, hilti::rt::ByteOrder::Network).valueOrThrow();
        if ( __trim ) {
            (*__data).trim(__cur.begin());
        }

        // End parsing production: Variable: num_3 -> uint<16>;

          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:65:5");
        (*__self).__on_num(hilti::rt::optional::value((*__self).num, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:65:5"));

        // Begin parsing production: Variable: data_2 -> bytes;
        ...
        // End parsing production: Variable: data_2 -> bytes;

          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:66:5");
        (*__self).__on_data(hilti::rt::optional::value((*__self).data, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:65:5"));
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:64:13-67:2");
        (*__self).__on_0x25_done();
        hilti::rt::debug::dedent(std::string("spicy"));
        return std::make_tuple(__cur, __lah, __lahe);
...
extern auto __hlt::TFTP::Data::parse1(hilti::rt::ValueReference<hilti::rt::Stream>& data, const std::optional<hilti::rt::stream::View>& cur) -> hilti::rt::stream::View {
    ...
    // Begin parsing production: Unit: TFTP_Data_2 -> num_3 data_2;
    std::tie(ncur, lahead, lahead_end) = (*unit).__parse_stage1(data, ncur, hilti::rt::Bool(true), lahead, lahead_end);
    // End parsing production: Unit: TFTP_Data_2 -> num_3 data_2;
...
auto __hlt::TFTP::Error::__parse_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    try {
        hilti::rt::debug::indent(std::string("spicy"));
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:88:14-91:2");
        (*__self).__on_0x25_init();

        // Begin parsing production: Variable: code_2 -> uint<16>;
        spicy::rt::detail::waitForInput(__data, __cur, hilti::rt::integer::safe<std::uint64_t>{2u}, std::string("expecting 2 bytes for unpacking value"), std::string("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:89:11"), hilti::rt::StrongReference<spicy::rt::filter::detail::Filters>());
        ...
        // End parsing production: Variable: code_2 -> uint<16>;

          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:89:5");
        (*__self).__on_code(hilti::rt::optional::value((*__self).code, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:89:5"));

        // Begin parsing production: Variable: msg_2 -> bytes;
        ...
        while ( hilti::rt::Bool(true) ) {
            spicy::rt::detail::waitForInput(__data, __cur, __until_bytes_sz, std::string("end-of-data reached before &until expression found"), std::string("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:90:11"), hilti::rt::StrongReference<spicy::rt::filter::detail::Filters>());
            hilti::rt::Bool found;
            hilti::rt::stream::SafeConstIterator it;
            std::tie(found, it) = __cur.find(__until_bytes);
            hilti::rt::optional::value((*__self).msg, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:89:5").append(__cur.sub(it));
            if ( found ) {
        ...
        // End parsing production: Variable: msg_2 -> bytes;

          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:90:5");
        (*__self).__on_msg(hilti::rt::optional::value((*__self).msg, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:89:5"));
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:88:14-91:2");
        (*__self).__on_0x25_done();
        hilti::rt::debug::dedent(std::string("spicy"));
        return std::make_tuple(__cur, __lah, __lahe);
...
extern auto __hlt::TFTP::Error::parse1(hilti::rt::ValueReference<hilti::rt::Stream>& data, const std::optional<hilti::rt::stream::View>& cur) -> hilti::rt::stream::View {
    ...
    // Begin parsing production: Unit: TFTP_Error_2 -> code_2 msg_2;
    std::tie(ncur, lahead, lahead_end) = (*unit).__parse_stage1(data, ncur, hilti::rt::Bool(true), lahead, lahead_end);
    // End parsing production: Unit: TFTP_Error_2 -> code_2 msg_2;
...
auto __hlt::TFTP::Packet::__parse_TFTP_Packet_stage2(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    spicy::rt::detail::waitForInput(__data, __cur, hilti::rt::integer::safe<std::uint64_t>{2u}, std::string("expecting 2 bytes for unpacking value"), std::string("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:17:9"), (*__self).__filters);
...

    {
      ...
      __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:17:5");
    (*__self).__on_op(hilti::rt::optional::value((*__self).op, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:17:5"));
    ...
    // End parsing production: Switch: switch -> [Opcode::RRQ] -> switch_case_1 | [Opcode::WRQ] -> switch_case_2 | [Opcode::DATA] -> switch_case_3 | [Opcode::ACK] -> switch_case_4 | [Opcode::ERROR] -> switch_case_5;
      ...
      __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:16:22-27:2");
    (*__self).__on_0x25_done();
...
auto __hlt::TFTP::Packet::__parse_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    try {
        ...
        if ( hilti::rt::StrongReference<hilti::rt::Stream> filtered = spicy::rt::filter::init(__self, __data, __cur); static_cast<bool>(filtered) ) {
            ...
            (*__self).__parse_TFTP_Packet_stage2(filtered_data, (*filtered_data).view(), __trim, __lah, __lahe);
            __cur = __cur.advance(__cur.size());
            if ( __trim ) {
                (*__data).trim(__cur.begin());
            }
...
auto __hlt::TFTP::Packet::__parse_switch_case_1_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).rrq, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:19:26")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    // End parsing production: Unit: TFTP_Request -> filename mode;

      __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:19:26");
    (*__self).__on_rrq(hilti::rt::optional::value((*__self).rrq, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:19:26"));
...
auto __hlt::TFTP::Packet::__parse_switch_case_2_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).wrq, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:20:26")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    // End parsing production: Unit: TFTP_Request -> filename mode;

      __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:20:26");
    (*__self).__on_wrq(hilti::rt::optional::value((*__self).wrq, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:20:26"));
...
auto __hlt::TFTP::Packet::__parse_switch_case_3_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).data, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:21:26")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    // End parsing production: Unit: TFTP_Data -> num data;

      __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:21:26");
    (*__self).__on_data(hilti::rt::optional::value((*__self).data, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:21:26"));
...
auto __hlt::TFTP::Packet::__parse_switch_case_4_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).ack, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:22:26")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    // End parsing production: Unit: TFTP_Acknowledgement -> num_2;

      __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:22:26");
    (*__self).__on_ack(hilti::rt::optional::value((*__self).ack, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:22:26"));
...
auto __hlt::TFTP::Packet::__parse_switch_case_5_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).error, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:23:26")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    // End parsing production: Unit: TFTP_Error -> code msg;

      __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:23:26");
    (*__self).__on_error(hilti::rt::optional::value((*__self).error, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:23:26"));
...
auto __hlt::TFTP::Packet::__parse_switch_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    auto __self = Packet::__self();
    hilti::rt::debug::indent(std::string("spicy"));
      __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:18:5-24:11");
    if ( const auto __x = hilti::rt::optional::value((*__self).op, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:18:14"); __x == TFTP::Opcode::RRQ ) {
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:18:25-19:47");
        ...
        // End parsing production: Sequence: switch_case_1 -> TFTP_Request;
          ...
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:19:47-20:48");
        ...
        // End parsing production: Sequence: switch_case_2 -> TFTP_Request;
          ...
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:20:48-21:38");
        ...
        // End parsing production: Sequence: switch_case_3 -> TFTP_Data;
          ...
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:21:38-22:49");
        ...
        // End parsing production: Sequence: switch_case_4 -> TFTP_Acknowledgement;
          ...
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:22:49-23:39");
        ...
        // End parsing production: Sequence: switch_case_5 -> TFTP_Error;
          ...
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:18:5-24:11");
        throw spicy::rt::ParseError(std::string("no matching case in switch statement"), "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:18:5-24:11");
    }
...
auto __hlt::TFTP::Request::__parse_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    try {
        hilti::rt::debug::indent(std::string("spicy"));
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:52:16-55:2");
        (*__self).__on_0x25_init();

        // Begin parsing production: Variable: filename_2 -> bytes;
        hilti::rt::Bytes __until_bytes = "\000"_b;
        hilti::rt::integer::safe<uint64_t> __until_bytes_sz = __until_bytes.size();
        hilti::rt::optional::valueOrInit((*__self).filename) = ""_b;
        while ( hilti::rt::Bool(true) ) {
            spicy::rt::detail::waitForInput(__data, __cur, __until_bytes_sz, std::string("end-of-data reached before &until expression found"), std::string("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:53:15"), hilti::rt::StrongReference<spicy::rt::filter::detail::Filters>());
            hilti::rt::Bool found;
            hilti::rt::stream::SafeConstIterator it;
            std::tie(found, it) = __cur.find(__until_bytes);
            hilti::rt::optional::value((*__self).filename, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:53:5").append(__cur.sub(it));
            if ( found ) {
                __cur = __cur.advance(it + __until_bytes_sz);
                if ( __trim ) {
                    (*__data).trim(__cur.begin());
        ...
        // End parsing production: Variable: filename_2 -> bytes;

          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:53:5");
        (*__self).__on_filename(hilti::rt::optional::value((*__self).filename, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:53:5"));

        // Begin parsing production: Variable: mode_2 -> bytes;
        ...
        while ( hilti::rt::Bool(true) ) {
            spicy::rt::detail::waitForInput(__data, __cur, __until_bytes_sz_2, std::string("end-of-data reached before &until expression found"), std::string("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:54:15"), hilti::rt::StrongReference<spicy::rt::filter::detail::Filters>());
            hilti::rt::Bool found;
            hilti::rt::stream::SafeConstIterator it;
            std::tie(found, it) = __cur.find(__until_bytes_2);
            hilti::rt::optional::value((*__self).mode, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:53:5").append(__cur.sub(it));
            if ( found ) {
        ...
        // End parsing production: Variable: mode_2 -> bytes;

          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:54:5");
        (*__self).__on_mode(hilti::rt::optional::value((*__self).mode, "/Users/bbannier/src/spicy-tftp/src/tftp.spicy:53:5"));
          __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:52:16-55:2");
        (*__self).__on_0x25_done();
        hilti::rt::debug::dedent(std::string("spicy"));
        return std::make_tuple(__cur, __lah, __lahe);
...
extern auto __hlt::TFTP::Request::parse2(hilti::rt::ValueReference<__hlt::TFTP::Request>& unit, hilti::rt::ValueReference<hilti::rt::Stream>& data, const std::optional<hilti::rt::stream::View>& cur) -> hilti::rt::stream::View {
    ...
    // Begin parsing production: Unit: TFTP_Request_2 -> filename_2 mode_2;
    std::tie(ncur, lahead, lahead_end) = (*unit).__parse_stage1(data, ncur, hilti::rt::Bool(true), lahead, lahead_end);
    // End parsing production: Unit: TFTP_Request_2 -> filename_2 mode_2;

    return ncur;
}

extern void __hlt::TFTP::__hook_Packet___on_0x25_done_0x7f9011527d50(hilti::rt::ValueReference<Packet>& __self) {
      __location__("/Users/bbannier/src/spicy-tftp/src/tftp.spicy:26:16");
