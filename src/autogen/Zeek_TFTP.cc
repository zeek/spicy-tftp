...
namespace picy::zeek::rt {
    extern void file_begin(const std::optional<std::string>& mime_type);
}
...
namespace picy::zeek::rt {
    extern void forward_packet(const hilti::rt::integer::safe<uint32_t>& identifier);
}

namespace picy::zeek::rt {
    extern auto fuid() -> std::string;
}
...
extern void __hlt::Zeek_TFTP::__hook_Request___on_0x25_done_853a(hilti::rt::ValueReference<TFTP::Request>& __self) {
    hilti::rt::detail::checkStack();
      __location__("/Users/robin/work/spicy/spicy-tftp/src/zeek_tftp.spicy:8:26-9:29");
    spicy::zeek::rt::confirm_protocol();
}

extern void __hlt::Zeek_TFTP::__hook_Request___on_0x25_error_bae8(hilti::rt::ValueReference<TFTP::Request>& __self) {
    hilti::rt::detail::checkStack();
      __location__("/Users/robin/work/spicy/spicy-tftp/src/zeek_tftp.spicy:12:27-13:62");
...
/* __HILTI_LINKER_V1__
{"joins":{"__hlt::TFTP::__hook_Request___on_0x25_done":[{"aux_types":[{"forward_decl":true,"forward_decl_prio":false,"id":"__hlt::TFTP::Request","type":"struct Request"}],"callee":{"args":[{"id":"__self","type":"hilti::rt::ValueReference<TFTP::Request>&"}],"attribute":"","const":false,"id":"__hlt::Zeek_TFTP::__hook_Request___on_0x25_done_853a","linkage":"extern","result":"void"},"declare_only":false,"id":"__hlt::TFTP::__hook_Request___on_0x25_done","priority":0}],"__hlt::TFTP::__hook_Request___on_0x25_error":[{"aux_types":[{"forward_decl":true,"forward_decl_prio":false,"id":"__hlt::TFTP::Request","type":"struct Request"}],"callee":{"args":[{"id":"__self","type":"hilti::rt::ValueReference<TFTP::Request>&"}],"attribute":"","const":false,"id":"__hlt::Zeek_TFTP::__hook_Request___on_0x25_error_bae8","linkage":"extern","result":"void"},"declare_only":false,"id":"__hlt::TFTP::__hook_Request___on_0x25_error","priority":0}]},"module":"Zeek_TFTP","namespace":"__hlt::Zeek_TFTP","path":"/Users/robin/work/spicy/spicy-tftp/src/zeek_tftp.spicy","version":1}
*/
